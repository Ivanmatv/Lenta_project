...
from api.serializers import ShopSerializer, ForecastSerializer, CategoriesSerializer, SalesSerializer
...
# Добавьте другие тесты для других сериализаторов, если это необходимо
